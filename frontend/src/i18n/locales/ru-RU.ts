export default {
  ...
  agent: {
    ...
    title: 'Агенты',
    subtitle: 'Настройте и управляйте агентами для персонализации поведения и возможностей диалога',
    ...
    capabilities: {
      ...
      kbCount: 'Указано баз знаний: {count}',
    ...
    empty: {
      ...
      description: 'Нажмите кнопку в правом верхнем углу, чтобы создать первого агента',
    },
    delete: {
    ...
    messages: {
      ...
      builtinReadonly: 'Встроенные агенты нельзя редактировать',
    ...
    editor: {
      ...
      basicInfoDesc: 'Настройка основной информации агента',
      modelConfig: 'Настройки модели',
      modelConfigDesc: 'Настройка параметров модели агента',
      capabilities: 'Возможности',
      capabilitiesDesc: 'Настройка возможностей и инструментов агента',
      toolsConfig: 'Инструменты',
      toolsConfigDesc: 'Настройка доступных инструментов агента',
      knowledgeConfig: 'База знаний',
      knowledgeConfigDesc: 'Настройка баз знаний для агента',
      webSearchConfig: 'Веб-поиск',
      webSearchConfigDesc: 'Настройка возможностей веб-поиска агента',
      configuration: 'Конфигурация',
      name: 'Название',
      namePlaceholder: 'Введите название агента',
      nameRequired: 'Требуется название агента',
      systemPromptRequired: 'Требуется системный промпт',
      modelRequired: 'Выберите модель',
      rerankModelRequired: 'Требуется модель ReRank при использовании баз знаний',
      contextsMissing: 'Шаблон контекста должен содержать плейсхолдер {{contexts}}, если включена база знаний',
      ...
      queryMissingInRewrite: 'Промпт перезаписи должен содержать плейсхолдер {{query}}',
      conversationMissing: 'Промпт перезаписи должен содержать плейсхолдер {{conversation}}',
      queryMissingInFallback: 'Резервный промпт должен содержать плейсхолдер {{query}}',
      avatar: 'Аватар',
      avatarPlaceholder: 'Введите эмодзи или выберите',
      description: 'Описание',
      descriptionPlaceholder: 'Введите описание агента',
      baseType: 'Базовый тип',
      normalDesc: 'Быстрый ответ, прямые ответы',
      agentDesc: 'Многошаговое мышление, глубокий анализ сложных вопросов',
      model: 'Модель',
      ...
      defaultPromptHint: 'Оставьте пустым для использования следующего системного промпта по умолчанию:',
      defaultContextTemplateHint: 'Оставьте пустым для использования следующего шаблона контекста по умолчанию:',
      contextTemplateRequired: 'Требуется шаблон контекста',
      availablePlaceholders: 'Доступные плейсхолдеры',
      placeholderHint: 'Введите {{ для автодополнения',
      ...
      mode: 'Режим работы',
      webSearch: 'Веб-поиск',
      webSearchMaxResults: 'Максимум результатов поиска',
      ...
      selectedKnowledgeBases: 'Выбранные базы знаний',
      selectedKnowledgeBasesDesc: 'Доступ только к выбранным базам знаний',
      noKnowledgeBase: 'Без базы знаний',
      noKnowledgeBaseDesc: 'Чистый диалог с моделью, без извлечения знаний',
      selectKnowledgeBases: 'Выберите базы знаний',
      rerankModel: 'Модель ReRank',
      rerankModelDesc: 'Используется для переранжирования результатов поиска в базе знаний для повышения точности',
      rerankModelPlaceholder: 'Выберите модель ReRank',
      maxIterations: 'Максимум итераций',
      allowedTools: 'Разрешённые инструменты',
      multiTurn: 'Многошаговый диалог',
      historyTurns: 'Количество ходов истории',
      // Retrieval Strategy
      retrievalStrategy: 'Стратегия извлечения',
      embeddingTopK: 'Embedding Top K',
      keywordThreshold: 'Порог ключевых слов',
      vectorThreshold: 'Порог векторного поиска',
      rerankTopK: 'Rerank Top K',
      rerankThreshold: 'Порог Rerank',
      // Conversation Settings
      conversationSettings: 'Диалог',
      // Advanced Settings
      ...
      placeholderContexts: 'Список извлечённого содержимого',
      placeholderCurrentTime: 'Текущее время (формат: 2006-01-02 15:04:05)',
      placeholderCurrentWeek: 'Текущий день недели (напр., Понедельник)',
      enableQueryExpansion: 'Расширение запроса',
      enableRewrite: 'Перезапись запроса',
      ...
      maxCompletionTokens: 'Максимум токенов ответа',
      ...
      // Hint descriptions for form fields
      hints: {
        nameDesc: 'Задайте название, по которому агента легко идентифицировать',
        ...
        systemPromptBuiltinSuffix: '(Оставьте пустым для использования системного значения по умолчанию)',
        contextTemplateDesc: 'Определите формат передачи извлечённого содержимого модели',
        modelDesc: 'Выберите большую языковую модель для использования этим агентом',
        temperatureDesc: 'Контролирует случайность вывода: 0 — наиболее детерминированный, 1 — наиболее случайный',
        maxCompletionTokensDesc: 'Максимальное количество токенов в генерируемом моделью ответе',
        conversationSettingsDesc: 'Настройка параметров многошагового диалога и перезаписи запросов',
        multiTurnDesc: 'При включении сохраняется контекст предыдущего диалога',
        historyTurnsDesc: 'Количество недавних ходов диалога для сохранения в контексте',
        enableRewriteDesc: 'Автоматически переписывать вопросы пользователя в многошаговых диалогах для разрешения ссылок и восполнения пропусков',
        rewritePromptSystemDesc: 'Системный промпт для перезаписи вопросов (оставьте пустым для значения по умолчанию)',
        rewritePromptUserDesc: 'Шаблон пользовательского промпта для перезаписи вопросов (оставьте пустым для значения по умолчанию)',
        allowedToolsDesc: 'Выберите инструменты, которые может использовать этот агент',
        requiresKb: '(Требуется настройка базы знаний)',
        maxIterationsDesc: 'Максимальное количество шагов рассуждения при выполнении задач агента',
        mcpServiceLabel: 'Сервисы MCP',
        mcpServiceDesc: 'Выберите сервисы MCP, которые может вызывать агент',
        selectMcpService: 'Выберите сервисы MCP',
        selectMcpServiceDesc: 'Выберите сервисы MCP для включения',
        selectMcpServicePlaceholder: 'Выберите сервисы MCP',
        all: 'Все',
        selected: 'Выбранные',
        none: 'Отключено',
        kbRangeDesc: 'Выберите область баз знаний, к которым агент может обращаться',
        selectKbDesc: 'Выберите базы знаний для связывания',
        faqPriorityStrategy: 'Стратегия приоритета FAQ',
        faqPriorityTooltip: 'Если ваша база знаний содержит FAQ (пары вопрос-ответ), вы можете включить эту стратегию для приоритета ответов FAQ над обычными документами',
        enableFaqPriority: 'Включить приоритет FAQ',
        enableFaqPriorityDesc: 'Ответы FAQ приоритизируются над обычными документами для повышения точности ответов',
        directAnswerThreshold: 'Порог прямого ответа',
        directAnswerThresholdDesc: 'Когда сходство между вопросом и FAQ превышает это значение, используется ответ FAQ напрямую',
        faqScoreBoost: 'Усиление оценки FAQ',
        faqScoreBoostDesc: 'Умножить оценки релевантности результатов FAQ на этот коэффициент для повышения ранжирования',
        webSearchDesc: 'При включении агент может искать информацию в интернете',
        webSearchMaxResultsDesc: 'Максимальное количество результатов, возвращаемых за один поиск',
        retrievalStrategyDesc: 'Настройка параметров извлечения и сортировки базы знаний',
        queryExpansionDesc: 'Автоматически расширять термины запроса для улучшения полноты поиска',
        embeddingTopKDesc: 'Максимальное количество результатов, возвращаемых векторным поиском',
        keywordThresholdDesc: 'Минимальная оценка релевантности для поиска по ключевым словам',
        vectorThresholdDesc: 'Минимальная оценка сходства для векторного поиска',
        rerankTopKDesc: 'Максимальное количество результатов для сохранения после переранжирования',
        rerankThresholdDesc: 'Минимальная оценка релевантности для переранжирования',
        fallbackStrategyDesc: 'Как обрабатывать ситуацию, когда в базе знаний не найдено релевантного содержимого',
        fixedReply: 'Фиксированный ответ',
        modelGenerated: 'Генерация моделью',
        fallbackResponseDesc: 'Фиксированный текст, возвращаемый при невозможности ответить',
        fallbackPromptDesc: 'Промпт для направления модели на генерацию ответа, когда ответ не найден в базе знаний',
        builtinAgentNotice: 'Это встроенный агент. Название и описание нельзя изменить, но параметры конфигурации можно настроить',
        availableVariables: 'Доступные переменные:',
        clickToInsert: '(Нажмите для вставки)',
        clickToInsertHint: '(Нажмите для вставки или введите {{ для списка)',
      },
    },
    selector: {
    ...
    builtinInfo: {
      quickAnswer: {
        name: 'Быстрый ответ',
        description: 'RAG вопрос-ответ по базе знаний для быстрых и точных ответов',
      },
      smartReasoning: {
        name: 'Умное рассуждение',
        description: 'Фреймворк ReAct с многошаговым мышлением и вызовом инструментов',
      },
      deepResearcher: {
        name: 'Глубокий исследователь',
        description: 'Ориентирован на углублённое исследование и комплексный анализ, способен создавать планы исследований, многомерный поиск информации, глубокое мышление и предоставление подробных аналитических отчётов',
      },
      dataAnalyst: {
        name: 'Аналитик данных',
        description: 'Ориентирован на запросы к базам данных и анализ данных, способен понимать бизнес-потребности, строить SQL-запросы, анализировать данные и предоставлять инсайты',
      },
      knowledgeGraphExpert: {
        name: 'Эксперт по графам знаний',
        description: 'Ориентирован на запросы к графам знаний и анализ связей, способен исследовать отношения между сущностями, обнаруживать скрытые связи и строить сети знаний',
      },
      documentAssistant: {
        name: 'Помощник по документам',
        description: 'Ориентирован на поиск документов и организацию контента, способен быстро находить документы, извлекать ключевую информацию и генерировать резюме',
      },
    },
    tools: {
      thinking: 'Мышление',
      thinkingDesc: 'Динамический и рефлексивный инструмент решения задач',
      todoWrite: 'Создать план',
      todoWriteDesc: 'Создание структурированных планов исследований',
      grepChunks: 'Поиск по ключевым словам',
      grepChunksDesc: 'Быстрый поиск документов и фрагментов, содержащих определённые ключевые слова',
      knowledgeSearch: 'Семантический поиск',
      knowledgeSearchDesc: 'Понимание вопросов и поиск семантически связанного контента',
      listKnowledgeChunks: 'Просмотр фрагментов документа',
      listKnowledgeChunksDesc: 'Получение полного содержимого фрагментов документов',
      queryKnowledgeGraph: 'Запрос к графу знаний',
      queryKnowledgeGraphDesc: 'Запрос связей из графа знаний',
      getDocumentInfo: 'Получить информацию о документе',
      getDocumentInfoDesc: 'Просмотр метаданных документа',
      databaseQuery: 'Запрос к базе данных',
      databaseQueryDesc: 'Запрос информации из базы данных',
    },
  },
  settings: {
    title: 'Настройки',
  ...
  common: {
    ...
    uploadAllSuccess: '{count} файлов успешно загружено!',
    uploadPartialSuccess: '{success} успешно, {fail} не удалось',
    uploadAllFailed: '{count} файлов не удалось загрузить',
    fileExists: 'Файл уже существует',
  ...
  chat: {
    ...
    webSearchResult: 'Результат веб-поиска',
  ...
  modelSettings: {
    ...
    builtin: {
      ...
      description: 'Встроенные модели видны всем арендаторам, конфиденциальная информация скрыта, их нельзя редактировать или удалять.',
      guideLink: 'Руководство по управлению встроенными моделями',
      tag: 'Встроенная'
    },
    chat: {
    ...
    toasts: {
      ...
      loadFailed: 'Не удалось загрузить список моделей',
      cannotEditBuiltin: 'Встроенные модели нельзя редактировать',
      cannotDeleteBuiltin: 'Встроенные модели нельзя удалять'
    },
  ...
  input: {
    ...
    customAgentNotReadyTooltip: 'Агент не готов. Сначала завершите настройку.',
    customAgentNotReadyDetail: 'Агент не готов. Пожалуйста, настройте следующее: {reasons}',
    customAgentMissingSummaryModel: 'Модель беседы (Summary Model)',
    customAgentMissingRerankModel: 'Модель переранжирования (Rerank Model)',
    goToAgentEditor: 'Перейти к настройке →',
    builtinAgentNotReadyDetail: 'Встроенный агент «{agentName}» не готов. Настройте: {reasons}',
    builtinAgentSettingName: 'Умное рассуждение',
    builtinNormalSettingName: 'Быстрые вопросы и ответы',
    webSearch: {
  ...
  promptTemplate: {
    ...
    withWebSearch: 'Веб-поиск',
    systemPrompt: {
      defaultKB: {
        name: 'Ассистент базы знаний',
        desc: 'Базовый шаблон вопросов-ответов по базе знаний для большинства сценариев',
      },
      expert: {
        name: 'Эксперт предметной области',
        desc: 'Профессиональные и углублённые ответы для технических областей',
      },
      customerService: {
        name: 'Служба поддержки',
        desc: 'Дружелюбный и тёплый стиль обслуживания для клиентской поддержки',
      },
      techSupport: {
        name: 'Техническая поддержка',
        desc: 'Профессиональное решение технических проблем с примерами кода',
      },
      pureChat: {
        name: 'Общий чат',
        desc: 'Универсальный диалоговый ассистент без базы знаний',
      },
      webSearch: {
        name: 'Ассистент веб-поиска',
        desc: 'Комбинирует веб-поиск для получения актуальной информации',
      },
    },
    contextTemplate: {
      default: {
        name: 'Стандартный шаблон',
        desc: 'Базовый шаблон контекста с чёткими ссылками и вопросами',
      },
      detailed: {
        name: 'Подробный шаблон',
        desc: 'Полный шаблон с детальными инструкциями и требованиями',
      },
      simple: {
        name: 'Простой шаблон',
        desc: 'Минимальный формат шаблона для простых сценариев вопросов-ответов',
      },
      qa: {
        name: 'Шаблон вопросов-ответов',
        desc: 'Оптимизированный шаблон для сценариев вопросов-ответов',
      },
    },
    rewriteSystem: {
      default: {
        name: 'Стандартная перезапись',
        desc: 'Стандартные правила разрешения ссылок и восполнения пропусков',
      },
      strict: {
        name: 'Строгая перезапись',
        desc: 'Более строгие требования к полным и независимым вопросам',
      },
    },
    rewriteUser: {
      default: {
        name: 'Стандартный формат',
        desc: 'Стандартный формат с историей диалога и текущим вопросом',
      },
      detailed: {
        name: 'Подробный формат',
        desc: 'Подробный формат с инструкциями к задаче',
      },
    },
    fallback: {
      default: {
        name: 'Стандартный резервный ответ',
        desc: 'Дружелюбное сообщение с предложениями при невозможности ответить',
      },
      polite: {
        name: 'Вежливый резервный ответ',
        desc: 'Более вежливое и подробное сообщение о невозможности ответить',
      },
      brief: {
        name: 'Краткий резервный ответ',
        desc: 'Короткое сообщение о невозможности ответить',
      },
      model: {
        name: 'Промпт резервной модели',
        desc: 'Промпт для направления модели на ответ с использованием общих знаний',
      },
    },
  },
}