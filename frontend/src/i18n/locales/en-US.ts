export default {
  ...
  agent: {
    ...
    editor: {
      ...
      hints: {
        nameDesc: 'Set a name that makes the agent easy to identify',
        ...
        systemPromptBuiltinSuffix: '(Leave empty to use system default)',
        contextTemplateDesc: 'Define the format for passing retrieved content to the model',
        modelDesc: 'Select the large language model for this agent to use',
        temperatureDesc: 'Control output randomness, 0 is most deterministic, 1 is most random',
        maxCompletionTokensDesc: 'Maximum number of tokens in the model\'s generated response',
        conversationSettingsDesc: 'Configure multi-turn conversation and query rewriting parameters',
        multiTurnDesc: 'When enabled, previous conversation context is preserved',
        historyTurnsDesc: 'Number of recent conversation turns to keep as context',
        enableRewriteDesc: 'Automatically rewrite user questions in multi-turn conversations to resolve references and fill in omissions',
        rewritePromptSystemDesc: 'System prompt for question rewriting (leave empty for default)',
        rewritePromptUserDesc: 'User prompt template for question rewriting (leave empty for default)',
        allowedToolsDesc: 'Select the tools this agent can use',
        requiresKb: '(Requires knowledge base configuration)',
        maxIterationsDesc: 'Maximum number of reasoning steps when executing agent tasks',
        mcpServiceLabel: 'MCP Services',
        mcpServiceDesc: 'Select MCP services the agent can call',
        selectMcpService: 'Select MCP Services',
        selectMcpServiceDesc: 'Select MCP services to enable',
        selectMcpServicePlaceholder: 'Select MCP services',
        all: 'All',
        selected: 'Selected',
        none: 'Disabled',
        kbRangeDesc: 'Select the knowledge base scope the agent can access',
        selectKbDesc: 'Select knowledge bases to associate',
        faqPriorityStrategy: 'FAQ Priority Strategy',
        faqPriorityTooltip: 'If your knowledge base contains FAQs (question-answer pairs), you can enable this strategy to prioritize FAQ answers over regular documents',
        enableFaqPriority: 'Enable FAQ Priority',
        enableFaqPriorityDesc: 'FAQ answers are prioritized over regular documents for improved response accuracy',
        directAnswerThreshold: 'Direct Answer Threshold',
        directAnswerThresholdDesc: 'When similarity between question and FAQ exceeds this value, use FAQ answer directly',
        faqScoreBoost: 'FAQ Score Boost',
        faqScoreBoostDesc: 'Multiply FAQ result relevance scores by this factor to boost ranking',
        webSearchDesc: 'When enabled, the agent can search the internet for information',
        webSearchMaxResultsDesc: 'Maximum number of results returned per search',
        retrievalStrategyDesc: 'Configure knowledge base retrieval and sorting parameters',
        queryExpansionDesc: 'Automatically expand query terms to improve recall',
        embeddingTopKDesc: 'Maximum number of results returned by vector search',
        keywordThresholdDesc: 'Minimum relevance score for keyword search',
        vectorThresholdDesc: 'Minimum similarity score for vector search',
        rerankTopKDesc: 'Maximum number of results to keep after reranking',
        rerankThresholdDesc: 'Minimum relevance score for reranking',
        fallbackStrategyDesc: 'How to handle when no relevant content is found in knowledge base',
        fixedReply: 'Fixed Response',
        modelGenerated: 'Model Generation',
        fallbackResponseDesc: 'Fixed text returned when unable to answer',
        fallbackPromptDesc: 'Prompt to guide model to generate response when no answer found in knowledge base',
        builtinAgentNotice: 'This is a built-in agent. Name and description cannot be modified, but configuration parameters can be adjusted',
        availableVariables: 'Available variables:',
        clickToInsert: '(Click to insert)',
        clickToInsertHint: '(Click to insert or type {{ to trigger list)',
      },
    },
    selector: {
      title: 'Select Agent',
    ...
    tools: {
      ...
      grepChunksDesc: 'Quickly find documents and chunks containing specific keywords',
      knowledgeSearch: 'Semantic Search',
      knowledgeSearchDesc: 'Understand questions and find semantically related content',
      listKnowledgeChunks: 'View Document Chunks',
      listKnowledgeChunksDesc: 'Get complete chunk content of documents',
      queryKnowledgeGraph: 'Query Knowledge Graph',
      queryKnowledgeGraphDesc: 'Query relationships from knowledge graph',
      getDocumentInfo: 'Get Document Info',
      getDocumentInfoDesc: 'View document metadata',
      databaseQuery: 'Database Query',
      databaseQueryDesc: 'Query information from database',
    },
  },
  settings: {
    title: 'Settings',
  ...
  common: {
    ...
    uploadAllSuccess: '{count} files uploaded successfully!',
    uploadPartialSuccess: '{success} succeeded, {fail} failed',
    uploadAllFailed: '{count} files upload failed',
    fileExists: 'File already exists',
...
\
  ...
  modelSettings: {
    ...
    builtin: {
      ...
      description: 'Built-in models are visible to all tenants, sensitive information will be hidden, and they cannot be edited or deleted.',
    ...
    toasts: {
      ...
      loadFailed: 'Failed to load model list',
      cannotEditBuiltin: 'Built-in models cannot be edited',
      cannotDeleteBuiltin: 'Built-in models cannot be deleted'
    },
