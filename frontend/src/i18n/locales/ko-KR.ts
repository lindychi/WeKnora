export default {
  ...
  agent: {
    ...
    toolFallback: "도구",
    title: "에이전트",
    subtitle: "에이전트를 구성하고 관리하여 대화 동작과 기능을 커스터마이즈하세요",
    createAgent: "에이전트 생성",
    builtin: "내장",
    noDescription: "설명 없음",
    selectAgent: "에이전트 선택",
    ...
    capabilities: {
      normal: "빠른 응답, 직접적인 답변",
      agent: "다단계 사고, 복잡한 질문을 위한 심층 분석",
      modelSpecified: "모델 지정됨",
      kbCount: "{count}개 지식베이스 지정됨",
      kbAll: "모든 지식베이스 접근 가능",
      kbDisabled: "지식베이스 비활성화됨",
      rerankSpecified: "재정렬 모델 지정됨",
    ...
    empty: {
      ...
      description: "우측 상단 버튼을 클릭하여 첫 번째 에이전트를 생성하세요",
    },
    delete: {
      confirmTitle: "에이전트 삭제",
      confirmMessage: '에이전트 "{name}"을(를) 삭제하시겠습니까? 이 작업은 취소할 수 없습니다.',
      confirmButton: "삭제 확인",
    },
    messages: {
    ...
    editor: {
      ...
      modelConfig: "모델 구성",
      modelConfigDesc: "에이전트 모델 파라미터 구성",
      capabilities: "기능",
      capabilitiesDesc: "에이전트 기능 및 도구 구성",
      toolsConfig: "도구",
      toolsConfigDesc: "에이전트가 사용할 수 있는 도구 구성",
      knowledgeConfig: "지식베이스",
      knowledgeConfigDesc: "에이전트의 지식베이스 구성",
      ...
      rerankModelRequired: "지식베이스 사용 시 재정렬 모델은 필수입니다",
      contextsMissing: "지식베이스 활성화 시 컨텍스트 템플릿에 {{contexts}} 플레이스홀더가 포함되어야 합니다",
      queryMissingInContext: "컨텍스트 템플릿에 {{query}} 플레이스홀더가 포함되어야 합니다",
      knowledgeBasesMissing: "모델이 사용 가능한 지식베이스를 알 수 있도록 시스템 프롬프트에 {{knowledge_bases}} 플레이스홀더를 포함하는 것이 좋습니다",
      queryMissingInRewrite: "재작성 사용자 프롬프트에 {{query}} 플레이스홀더가 포함되어야 합니다",
      conversationMissing: "재작성 사용자 프롬프트에 {{conversation}} 플레이스홀더가 포함되어야 합니다",
      queryMissingInFallback: "폴백 프롬프트에 {{query}} 플레이스홀더가 포함되어야 합니다",
      avatar: "아바타",
      avatarPlaceholder: "이모지 입력 또는 선택",
      description: "설명",
      descriptionPlaceholder: "에이전트 설명 입력",
      baseType: "기본 유형",
      normalDesc: "빠른 응답, 직접적인 답변",
      agentDesc: "다단계 사고, 복잡한 질문을 위한 심층 분석",
      model: "모델",
      modelPlaceholder: "모델 선택",
      systemPrompt: "시스템 프롬프트",
      systemPromptPlaceholder: "에이전트 동작과 역할을 정의하는 사용자 정의 시스템 프롬프트 (동적 웹 검색 동작을 위해 {{web_search_status}} 플레이스홀더 사용)",
      defaultPromptHint: "비워두면 다음 기본 시스템 프롬프트가 사용됩니다:",
      defaultContextTemplateHint: "비워두면 다음 기본 컨텍스트 템플릿이 사용됩니다:",
      contextTemplateRequired: "컨텍스트 템플릿은 필수입니다",
      availablePlaceholders: "사용 가능한 플레이스홀더",
      placeholderHint: "{{ 를 입력하여 자동완성 트리거",
      temperature: "온도",
      welcomeMessage: "환영 메시지",
      welcomeMessagePlaceholder: "이 에이전트가 선택되었을 때 표시되는 메시지",
      ...
      allKnowledgeBasesDesc: "에이전트가 모든 지식베이스에 접근 가능",
      selectedKnowledgeBases: "선택된 지식베이스",
      selectedKnowledgeBasesDesc: "선택된 지식베이스만 접근",
      noKnowledgeBase: "지식베이스 없음",
      noKnowledgeBaseDesc: "순수 모델 대화, 지식 검색 없음",
      selectKnowledgeBases: "지식베이스 선택",
      rerankModel: "재정렬 모델",
      rerankModelDesc: "지식베이스 검색 결과를 재정렬하여 정확도 향상",
      rerankModelPlaceholder: "재정렬 모델 선택",
      maxIterations: "최대 반복 횟수",
      allowedTools: "허용된 도구",
      multiTurn: "다중 턴 대화",
      historyTurns: "히스토리 턴 수",
      retrievalStrategy: "검색 전략",
      embeddingTopK: "임베딩 Top K",
      keywordThreshold: "키워드 임계값",
      vectorThreshold: "벡터 임계값",
      rerankTopK: "재정렬 Top K",
      ...
      enableRewrite: "쿼리 재작성",
      rewritePromptSystem: "재작성 시스템 프롬프트",
      rewritePromptSystemPlaceholder: "비워두면 기본 프롬프트 사용",
      rewritePromptUser: "재작성 사용자 프롬프트",
      rewritePromptUserPlaceholder: "비워두면 기본 프롬프트 사용",
      maxCompletionTokens: "최대 완성 토큰",
      fallbackStrategy: "폴백 전략",
      fallbackResponse: "고정 응답",
      fallbackResponsePlaceholder: "죄송합니다, 이 질문에 답변할 수 없습니다.",
      fallbackPrompt: "폴백 프롬프트",
      fallbackPromptPlaceholder: "비워두면 기본 프롬프트 사용",
      // 설명 텍스트 (hints)
      hints: {
        nameDesc: "에이전트를 쉽게 식별할 수 있는 이름을 설정하세요",
        descriptionDesc: "에이전트의 용도와 특징을 간략히 설명하세요",
        systemPromptDesc: "에이전트의 동작과 역할을 정의하는 사용자 정의 시스템 프롬프트",
        systemPromptBuiltinSuffix: "(비워두면 시스템 기본값 사용)",
        contextTemplateDesc: "검색된 콘텐츠를 모델에 전달하는 포맷 정의",
        modelDesc: "에이전트가 사용할 대규모 언어 모델 선택",
        temperatureDesc: "출력의 무작위성 제어, 0은 가장 확정적, 1은 가장 무작위",
        maxCompletionTokensDesc: "모델이 생성하는 응답의 최대 토큰 수",
        conversationSettingsDesc: "다중 턴 대화 및 질문 재작성 관련 파라미터 구성",
        multiTurnDesc: "활성화하면 이전 대화 컨텍스트가 유지됩니다",
        historyTurnsDesc: "컨텍스트로 유지할 최근 대화 턴 수",
        enableRewriteDesc: "다중 턴 대화 시 사용자 질문을 자동으로 재작성하여 지시어 해소 및 생략 보완",
        rewritePromptSystemDesc: "질문 재작성용 시스템 프롬프트 (비워두면 기본값 사용)",
        rewritePromptUserDesc: "질문 재작성용 사용자 프롬프트 템플릿 (비워두면 기본값 사용)",
        allowedToolsDesc: "에이전트가 사용할 수 있는 도구 선택",
        requiresKb: "(지식베이스 구성 필요)",
        maxIterationsDesc: "에이전트 작업 실행 시 최대 추론 단계 수",
        mcpServiceLabel: "MCP 서비스",
        mcpServiceDesc: "에이전트가 호출할 수 있는 MCP 서비스 선택",
        selectMcpService: "MCP 서비스 선택",
        selectMcpServiceDesc: "활성화할 MCP 서비스 선택",
        selectMcpServicePlaceholder: "MCP 서비스 선택",
        all: "전체",
        selected: "선택",
        none: "비활성화",
        kbRangeDesc: "에이전트가 접근할 수 있는 지식베이스 범위 선택",
        selectKbDesc: "연결할 지식베이스 선택",
        faqPriorityStrategy: "FAQ 우선 전략",
        faqPriorityTooltip: "지식베이스에 FAQ(질문-답변 쌍)가 포함된 경우, 이 전략을 활성화하여 FAQ 답변이 일반 문서보다 우선하도록 할 수 있습니다",
        enableFaqPriority: "FAQ 우선 활성화",
        enableFaqPriorityDesc: "FAQ 답변이 일반 문서보다 우선하여 참조되어 응답 정확도 향상",
        directAnswerThreshold: "직접 답변 임계값",
        directAnswerThresholdDesc: "질문과 FAQ의 유사도가 이 값을 초과하면 FAQ 답변을 직접 사용",
        faqScoreBoost: "FAQ 점수 가중치",
        faqScoreBoostDesc: "FAQ 결과의 관련성 점수에 이 계수를 곱하여 순위 상승",
        webSearchDesc: "활성화하면 에이전트가 인터넷을 검색하여 정보를 얻을 수 있습니다",
        webSearchMaxResultsDesc: "각 검색당 반환되는 최대 결과 수",
        retrievalStrategyDesc: "지식베이스 검색 및 정렬 파라미터 구성",
        queryExpansionDesc: "쿼리 용어를 자동으로 확장하여 재현율 향상",
        embeddingTopKDesc: "벡터 검색이 반환하는 최대 결과 수",
        ...
        fallbackStrategyDesc: "지식베이스에서 관련 콘텐츠를 찾을 수 없을 때의 처리 방법",
        fixedReply: "고정 응답",
        modelGenerated: "모델 생성",
        fallbackResponseDesc: "응답할 수 없을 때 반환되는 고정 텍스트",
        fallbackPromptDesc: "지식베이스에서 답변을 찾을 수 없을 때 모델이 응답을 생성하도록 안내하는 프롬프트",
        builtinAgentNotice: "이것은 내장 에이전트입니다. 이름과 설명은 수정할 수 없지만 구성 파라미터는 조정할 수 있습니다",
        availableVariables: "사용 가능한 변수:",
        clickToInsert: "(클릭하여 삽입)",
        clickToInsertHint: "(클릭하여 삽입하거나 {{ 를 입력하여 목록 호출)",
      },
    },
    selector: {
      title: "에이전트 선택",
    ...
    builtinInfo: {
      quickAnswer: {
        name: "빠른 답변",
        description: "지식베이스 RAG Q&A로 빠르고 정확한 답변 제공",
      },
      smartReasoning: {
        name: "스마트 추론",
        description: "다단계 사고와 도구 호출이 가능한 ReAct 추론 프레임워크",
      },
      deepResearcher: {
        name: "심층 연구원",
        description: "심층 연구와 종합 분석에 집중, 연구 계획 수립, 다차원 정보 검색, 깊은 사고 및 철저한 분석 보고서 제공 가능",
      },
      dataAnalyst: {
        name: "데이터 분석가",
        description: "데이터베이스 쿼리 및 데이터 분석에 집중, 비즈니스 요구 이해, SQL 쿼리 작성, 데이터 분석 및 인사이트 제공 가능",
      },
      knowledgeGraphExpert: {
        name: "지식 그래프 전문가",
        description: "지식 그래프 쿼리 및 관계 분석에 집중, 엔티티 관계 탐색, 숨겨진 연결 발견 및 지식 네트워크 구축 가능",
      },
      documentAssistant: {
        name: "문서 어시스턴트",
        description: "문서 검색 및 콘텐츠 정리에 집중, 빠른 문서 위치 파악, 핵심 정보 추출 및 요약 생성 가능",
      },
    },
    tools: {
      thinking: "사고",
      ...
      grepChunks: "키워드 검색",
      grepChunksDesc: "특정 키워드가 포함된 문서와 청크를 빠르게 찾기",
      knowledgeSearch: "시맨틱 검색",
      knowledgeSearchDesc: "질문을 이해하고 의미적으로 관련된 콘텐츠 찾기",
      listKnowledgeChunks: "문서 청크 보기",
      listKnowledgeChunksDesc: "문서의 전체 청크 내용 가져오기",
      queryKnowledgeGraph: "지식 그래프 쿼리",
      queryKnowledgeGraphDesc: "지식 그래프에서 관계 쿼리",
      getDocumentInfo: "문서 정보 가져오기",
      getDocumentInfoDesc: "문서 메타데이터 보기",
      databaseQuery: "데이터베이스 쿼리",
      databaseQueryDesc: "데이터베이스에서 정보 쿼리",
    },
  },
  settings: {
    title: "설정",
  ...
  common: {
    ...
    uploadFailed: "업로드 실패!",
    uploadAllSuccess: "{count}개 파일 업로드 성공!",
    uploadPartialSuccess: "{success}개 성공, {fail}개 실패",
    uploadAllFailed: "{count}개 파일 업로드 실패",
    fileExists: "파일이 이미 존재합니다",
    missingKbId: "지식베이스 ID가 없습니다",
  ...
  model: {
    ...
    editor: {
      ...
      providers: {
        ...
        aliyun: {
          label: "알리바바 클라우드 DashScope",
          description: "qwen-plus, tongyi-embedding-vision-plus, qwen3-rerank 등",
        },
        zhipu: {
          label: "지푸 AI",
          description: "glm-4.7, embedding-3, rerank 등",
        },
        openrouter: {
          label: "OpenRouter",
        ...
        jina: {
          label: "Jina AI",
          description: "jina-clip-v1, jina-embeddings-v2-base-zh 등",
        },
        volcengine: {
          label: "화산 엔진",
  ...
  input: {
    ...
    messages: {
      ...
      agentSelected: '에이전트 "{name}"(이)가 선택되었습니다',
    },
    ...
    builtinAgentNotReadyDetail: '내장 에이전트 "{agentName}"이(가) 준비되지 않았습니다. 다음을 설정해주세요: {reasons}',
    builtinAgentSettingName: "스마트 추론",
    builtinNormalSettingName: "빠른 Q&A",
    webSearchDisabledByAgent: "현재 에이전트에 의해 웹 검색이 비활성화되었습니다",
    webSearchForcedByAgent: "현재 에이전트에 의해 웹 검색이 활성화되어 끌 수 없습니다",
    kbLockedByAgent: "현재 에이전트에 의해 지식베이스 구성이 잠겨 있습니다",
    kbDisabledByAgent: "현재 에이전트에 의해 지식베이스가 비활성화되었습니다",
    cannotRemoveAgentKb: "에이전트가 구성한 지식베이스는 제거할 수 없습니다",
    agentConfiguredKb: "에이전트가 구성함, 제거 불가",
    modelLockedByAgent: "현재 에이전트에 의해 모델 선택이 잠겨 있습니다",
  ...
  modelSettings: {
    ...
    builtin: {
      title: "내장 모델",
      description: "내장 모델은 모든 테넌트에 표시되며, 민감한 정보는 숨겨지고 편집하거나 삭제할 수 없습니다.",
    ...
    toasts: {
      ...
      loadFailed: "모델 목록 로드 실패",
      cannotEditBuiltin: "내장 모델은 편집할 수 없습니다",
      cannotDeleteBuiltin: "내장 모델은 삭제할 수 없습니다",
    },
  ...
  promptTemplate: {
    ...
    systemPrompt: {
      ...
      expert: {
        name: "도메인 전문가",
        desc: "기술 분야를 위한 전문적이고 심층적인 답변",
      },
      customerService: {
        name: "고객 서비스",
        desc: "고객 지원을 위한 친절하고 따뜻한 서비스 스타일",
      },
      techSupport: {
        name: "기술 지원",
      ...
      pureChat: {
        name: "일반 대화",
        desc: "지식베이스 없는 일반 대화 어시스턴트",
      },
      webSearch: {
        name: "웹 검색 어시스턴트",
        desc: "최신 정보를 위해 웹 검색을 결합",
      },
    },
    contextTemplate: {
      default: {
        name: "표준 템플릿",
        desc: "명확한 참조와 질문이 포함된 기본 컨텍스트 템플릿",
      },
      detailed: {
        name: "상세 템플릿",
        desc: "상세한 지시사항과 요구사항이 포함된 완전한 템플릿",
      },
      simple: {
        name: "간단 템플릿",
        desc: "간단한 Q&A 시나리오를 위한 최소한의 템플릿 형식",
      },
      qa: {
        name: "Q&A 템플릿",
    ...
    rewriteSystem: {
      ...
      strict: {
        name: "엄격한 재작성",
        desc: "완전하고 독립적인 질문을 위한 더 엄격한 요구사항",
      },
    },
    rewriteUser: {
      default: {
        name: "표준 형식",
        desc: "대화 기록과 현재 질문이 포함된 표준 형식",
      },
      detailed: {
        name: "상세 형식",
        desc: "작업 지시사항이 포함된 상세 형식",
      },
    },
    fallback: {
      default: {
        name: "표준 폴백",
        desc: "답변할 수 없을 때 제안사항과 함께 친절한 메시지",
      },
      polite: {
        name: "정중한 폴백",
      ...
      model: {
        name: "모델 폴백 프롬프트",
        desc: "일반 지식으로 답변하도록 모델을 안내하는 프롬프트",
      },
    },
  },
};
